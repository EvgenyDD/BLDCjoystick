 ...
 *******************************************************************************/
void LCD_String(uint8_t x, uint8_t y, uint8_t* s, uint8_t scale)
{
 ...
 * Function Name  : LCD_String
 *******************************************************************************/
void LCD_StringCentered(uint8_t x, uint8_t y, uint8_t* s, uint8_t scale)
{
	int len = strlen(s);
 ...
 * Description    :
 *******************************************************************************/
void LCD_FloatPseudoWString(uint8_t x, uint8_t y, int32_t num, uint8_t *text, uint8_t prec, uint8_t scale)
{
	uint8_t d[25];
	ftoaPseudo_(num, d, prec);
	strcat_(d, text);
...
void LCD_Celsium(uint8_t x, uint8_t y, uint8_t *text, uint16_t num, uint8_t scale)
{
	uint8_t d[25], xx[20];
	strcpy_(d, text);
	itoa_(num, xx);
	strcat_(d, xx);
	strcat_(d, (uint8_t *)"\x7f");
	LCD_String(x, y, d, scale);
}
