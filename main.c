...
#define M_EACH_SAMPLES 	40
	...
	//ZERO
	LCD_Clear();
	LCD_StringCentered(0, 80, (uint8_t*) "ZERO", 1);
	LCD_StringCentered(0, 70, (uint8_t*) "STICK", 1);
	LCD_Update();
...
//		delay_ms(10);
	...
	//Max 1
	LCD_Clear();
	LCD_String(0, 0, (uint8_t*) "MAX", 1);
	LCD_StringCentered(0, 70, (uint8_t*) "THROT", 1);
	LCD_Update();

	while((int16_t)(GetThrottle() - thrStart) < 600/* || (GetBrake() - brkStart) > 100*/);

	LCD_Clear();
	LCD_String(0, 0, (uint8_t*) "MEAS", 1);
	LCD_StringCentered(0, 70, (uint8_t*) "THROT", 1);
	LCD_Update();
	...
	LCD_Clear();
	LCD_String(0, 0, (uint8_t*) "MAX", 1);
	LCD_StringCentered(0, 70, (uint8_t*) "BRAKE", 1);
	LCD_Update();
...
//	//MAX BOTH
//	LCD_StringCentered(0, 80, (uint8_t*) "MAX", 1);
//	LCD_StringCentered(0, 70, (uint8_t*) "STICK", 1);
//	LCD_Update();
//
